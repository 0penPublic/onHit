package mba.vm.onhit.model.trace
...
object TagTraceCodec {
    ...
    private const val TAG_SUB_NULL_RESP: Byte = 0x13
    ...
    fun encode(trace: TagTrace): ByteArray {
        ...
        for (item in trace.transceiveData) {
            ...
            if (item.resp == null) {
                writeTlv(elemWriter, TAG_SUB_NULL_RESP, byteArrayOf())
            } else {
                writeTlv(elemWriter, TAG_SUB_RESP, item.resp)
            }
