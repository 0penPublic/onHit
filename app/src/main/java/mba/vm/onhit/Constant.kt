...
class Constant {
    companion object {
        ...
        const val BROADCAST_START_TAG_RECORDER_REQUEST = "${BuildConfig.APPLICATION_ID}.START_TAG_RECORDER_REQUEST"
        const val BROADCAST_STOP_TAG_RECORDER_REQUEST = "${BuildConfig.APPLICATION_ID}.STOP_TAG_RECORDER_REQUEST"
